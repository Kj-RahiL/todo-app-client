...
const Footer = () => {
    return (
        <div className="">
            ...
            <footer className="footer px-10 py-4 border-t bg-lime-900/20 text-base-content border-base-300">
                <aside className="items-center grid-flow-col">
                <p>Copyright © 2023 - All right reserved by Todo App Management</p>
                </aside>
